...
use soroban_sdk::{
    contracttype, symbol_short, vec, Address, ConversionError, Env, String, Symbol, TryIntoVal,
    Val, Vec,
};
...
impl AtomicTransactionSupport for MarketplaceAtomicSupport {
    ...
    fn rollback_step(
            ...
            .get::<_, AtomicStepState>(&step_key)
        {
            ...
            let rollback_contract = state
                .rollback_contract
                .clone()
                .unwrap_or(state.contract.clone());
                ...
                .map_or_else(
                    |e| {
                        Self::create_atomic_audit_log(
                            ...
                            "rollback_warning",
                            false,
                            Some("Rollback execution warning"),
                        );
                        false
                    },
                    |_| true,
